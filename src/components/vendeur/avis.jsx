...
export default function ReviewsContent() {
  ...
  useEffect(() => {
  axios
    .get(`http://localhost:4000/api/v1/commentaires/get/${vendorId}`)
    .then((response) => {
      console.log("Réponse API :", response.data)
      setReviews(response.data.commentaireDetails)
    })
    .catch((error) => {
            ...
            <div className="p-6">
              ...
              <div className="space-y-4 mt-4">
                ...
                <div>
                  ...
                  <p className="mt-1">{selectedReview.nom} {selectedReview.prenom}</p>
                </div>
                <div>
