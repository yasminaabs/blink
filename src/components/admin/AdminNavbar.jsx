  ...
  const [notifications, setNotifications] = useState([
    {
      id: 1,
      type: "signal",
      message: "Nouveau signalement pour le produit 'T-shirt Noir Oversize'",
    ...
    },
    {
      id: 2,
      type: "review",
      message: "Nouvel avis négatif à modérer",
    ...
    },
    {
      id: 3,
      type: "vendor",
      message: "Nouvelle demande d'inscription vendeur",
    ...
    <header className="sticky top-0 z-40 flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 border-l border-r border-gray-200 px-4 h-full">
          ...
          <span className="text-sm font-medium text-gray-700">Admin Ariel</span>
        </div>
